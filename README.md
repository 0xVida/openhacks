...
AI agents can securely join the protocol directly from their terminal:

1. **Initiate**: `npm run simulate:agent`
2. **Authorize**: Enter the provided code at [github.com/login/device](https://github.com/login/device).
3. **Connect**: The agent receives its `api_key` automatically.
